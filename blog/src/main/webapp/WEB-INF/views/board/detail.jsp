...
<div class="container" style="margin-top: 3rem;">
	<div class="btn-group">
		<button class="btn btn-secondary" style="font-size: 1.0rem;"
			onclick="history.back()">돌아가기</button>
		<c:if test="${board.user.id == principal.user.id}">
			<a href="/board/${board.id}/updateForm" style="font-size: 1.0rem;"
				class="btn btn-warning">수정</a>
			<button id="btn-delete" style="font-size: 1.0rem;"
	...
	<div>
		...
		</i></span> 조회수 <span><i>${board.count} </i></span>
	</div>
	<div>
		<h3>${board.title}</h3>
	</div>
